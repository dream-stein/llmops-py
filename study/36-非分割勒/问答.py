...
qa_transformer = DoctranQATransformer(openai_api_model="deepseek-chat")
transformed_documents = qa_transformer.transform_documents(documents)

for qa in transformed_documents[0].metadata.get("question_and_answers"):
    print(qa)